...
<meta name="description"
	content="HITK Centro de processo seletivo é um sistema simples para aplicar testes para profissionais da àrea de TI." />
  ...
  $(function() {
    ...
    function callback() {
 	...
 	function LoadTest() {
		...
		$('#content_wrapper').load('_FirstStep/teste.htm');
		$( "#content_wrapper" ).removeAttr( "style" ).hide().fadeIn();
...
<body>
	<div id="templatemo_header_wrapper">
		<div id="templatemo_header">
			...
			<p>Sistema simples para atestar de forma básica os conhecimentos do
				candidato na forma de perguntas específicas da vaga.</p>
	...
	<div id="content_wrapper">
		...
		<div id="templatemo_sidebar">
			...
			<div class="sidebar_box">
				...
				<div class="news_box">
					<p class="post_info">
						Nível:
						<dfn>Desenvolvedor PHP Sênior</dfn>
					</p>
					<p class="post_info">
						Curriculum: <a
			...
			<div class="sidebar_box">
				...
				<h2>Questões</h2>
				<p>
					Algorítmos: <strong>3</strong>
				</p>
				<p>
					Conhecimentos básicos PHP: <strong>10</strong>
				</p>
				<p>
					Orientação Objetos: <strong>10</strong>
				</p>
				<p>
				...
				<p>
					Sessões: <strong>5</strong>
				</p>
				<p>
					Segurança: <strong>5</strong>
				</p>
				<p>
			...
			<div class="sidebar_box">
				...
				<h2>Iniciar Prova!</h2>
				<p>Leia a informações na página e se tudo estiver corretamente
					inserido e entendido clique no botão abaixo para iniciar o
					processo.</p>
		...
		<div id="templatemo_content">
			...
			<div class="content_box">
				...
				<p>A vaga é para um perfil autodidata, que saiba correr atrás de
					soluções, que se esforce para entender o código sem ficar
					perguntando a todo minuto. Claro que dúvidas sempre aparecem, mas
					esperamos que dúvidas simples da linguagem o candidato seja capaz
					de pesquisar e aprender por si só, seguindo o padrão do projeto. Os
					itens exigidos para a prova são:</p>
				...
				<div class="section_w250 float_r">
					...
					<ul class="list_01">
						<li>Lógica programação/Algorítmos</li>
						<li>Conhecimentos linguagem PHP</li>
						<li>Orientação Objetos PHP</li>
			...
			<div class="content_box">
				...
				<p>O processo seletivo da HITK Consultoria é composto de 3 etapas</p>
				<ul>
					<li>Prova teórica online</li>
					<li>Prova prática online</li>
					<li>Entrevista com o gerente do projeto por conferência</li>
				</ul>
				<div class="section_w250 float_l">
					<h3>Prova teórica</h3>
					<p>A prova teórica terá o equivalente a 60 questões em média, será
						permitido a busca de soluções em mecanismos de pesquisa, assim
						como parar a prova e iniciar em outro momento (todo esse processo
						será contabilizado).</p>

				</div>

				<div class="section_w250 float_r">
					<h3>Prova prática</h3>
					<p>A prova prática terá o equivalente a 5 atividades em um servidor
						GNU/Linux com Apache ou NGINX, será permitido a busca de soluções
						em mecanismos de pesquisa, o candidato terá atividades na
						linguagem PHP, estrutura de diretórios e acesso subversion.</p>
